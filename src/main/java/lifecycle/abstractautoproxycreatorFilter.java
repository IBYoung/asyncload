...
public abstract class abstractautoproxycreatorFilter extends ProxyConfig
    ...
    public void setInterceptorFilter(Map<String, String> interceptorFilter) {
...
//        this.interceptorNames=new String[0];
        System.out.println("################################");
